      ...
      <div className="container-x">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-8">
          ...
          <Reveal delay={0.2} className="relative">
            ...
            <div className="glass absolute bottom-4 right-0 flex animate-float items-center gap-2.5 rounded-2xl px-4 py-3 sm:right-2">
              <span className="grid size-9 place-items-center rounded-xl bg-navy-950/10 text-navy-900 dark:bg-white/10 dark:text-white">
